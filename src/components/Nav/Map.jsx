...
import ReactFlow, {MiniMap, Controls, Background, useReactFlow, useStore, ReactFlowProvider, applyNodeChanges, applyEdgeChanges, addEdge} from 'react-flow-renderer';
...
const Map = () => {
  ...
  const handleClick = () => {
    setnewedges(edges)
      ...
      const onConnect = useCallback((connection) => setEdgesState((eds) => addEdge(connection, eds)));
